...
def fetchNext(posn):
    ...
    if not url.startswith('plugin://plugin.audio.mp3quran'):
        return
...
class Downloader(threading.Thread):
     ...
     def downloadFile(self):
         try:
             headers = {'Host':'mp3quran.net/eng', 'Range':'bytes=0-', 'User-Agent':'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:44.0) Gecko/20100101 Firefox/44.0', 'Accept':'audio/webm,audio/ogg,audio/wav,audio/*;q=0.9,application/ogg;q=0.7,video/*;q=0.6,*/*;q=0.5','Referer':'http://www.mp3quran.net/eng'}
